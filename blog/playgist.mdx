...
export const description = "PlayGist is a web fiddle for GitHub Gists. It's a developer-friendly environment for running, sharing, and exploring your GitHub Gists without the need for extensive cloud storage.";
